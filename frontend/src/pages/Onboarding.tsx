    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-lg p-8 w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-800">Let's set up your courses 📚</h1>
          <p className="text-gray-500 mt-2">Add your courses and exam dates so AI can build your study plan</p>
        </div>
            ...
            {courses.map((course, index) => (
              ...
              >
                <div>
                  ...
                  <p className="text-sm text-gray-500">Exam: {course.exam_date}</p>
                </div>
        ...
        >
          {loading ? 'Saving courses...' : `Continue with ${courses.length} course${courses.length !== 1 ? 's' : ''} →`}
        </button>
      </div>
    </div>
  );
